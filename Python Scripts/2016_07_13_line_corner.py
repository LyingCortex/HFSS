# -*- coding: utf-8 -*-
"""
Created on Wed Jul 13 15:49:37 2016
...
Points = [('-off_u' ,'L_line11+W_line-W_line*coff_corner' ,0),('-off_u' ,'L_line11+W_line' ,0),('-off_u' ,'L_line11+W_line-W_line*coff_corner' ,0)]

name = ['Line1corner'+ str(i+1) for i in range(7)]
material = 'copper'
