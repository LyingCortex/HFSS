# -*- coding: utf-8 -*-
"""
Created on Mon Jun 20 20:05:31 2016
...
local_var_array = get_design_varibles()
varible_value = [('wp1',wp1),('wp2',wp2),('l1',l1),('l2',l2),('p',p)]
Add_varible_list(varible_value)

varible_value_without_unit = [('N1', N1), ('N2', N2), ('N3', N3), ('N4', N4), ('N5',N5)]
Add_varible_list_without_unit(varible_value_without_unit) 

list1 = [('wp1/2', 'l1/N1*'+str(i), '0')  for i in range(N1+1)]
list8 = [('-wp1/2', 'l1/N1*'+str(i), '0')  for i in range(N1+1)]
list2 = [('wp1/2 - (wp1-wp2)/2/N2*'+str(i), 'l1', '0') for i in range(1,N2+1)]
list7 = [('-wp1/2 + (wp1-wp2)/2/N2*'+str(i), 'l1', '0') for i in range(1,N2+1)]
list3 = [('wp2/2', 'l1+l2/N3*'+str(i),' 0' ) for i in range(1, N3+1)]
list6 = [('-wp2/2', 'l1+l2/N3*'+str(i),' 0' ) for i in range(1, N3+1)]
list4 = [('wp2/2-(wp2-a)/2/N4*'+ str(i), 'l1+l2',' 0') for i in range(1, N4+1)]
list5 = [('-wp2/2+(wp2-a)/2/N4*'+ str(i), 'l1+l2',' 0') for i in range(1, N4+1)]
...
################### the design varibles used in the design
#local_var_array = get_design_varibles()
#varible_value = [('wp1',wp1),('wp2',wp2),('l1',l1),('l2',l2)]
#Add_varible_list(varible_value)
#
#    
#
#list1 = [('wp1/2', 'l1/3*'+str(i), '0')  for i in range(4)]
#list8 = [('-wp1/2', 'l1/3*'+str(i), '0')  for i in range(4)]
#list2 = [('wp1/2 - (wp1-wp2)/4 *'+str(i), 'l1', '0') for i in range(1,3)]
#list7 = [('-wp1/2 + (wp1-wp2)/4 *'+str(i), 'l1', '0') for i in range(1,3)]
#list3 = [('wp2/2', 'l1+l2/2*'+str(i),' 0' ) for i in range(1, 3)]
#list6 = [('-wp2/2', 'l1+l2/2*'+str(i), '0' ) for i in range(1, 3)]
...
list_sum = [(x, y+'-l1', z) for (x, y, z) in list_total]

h= 'h'
material = 'pec'
r= 'rad'
for i in range(length_via):
    CreateCylinder(list_sum[i], r, h, list_via_name[i], material, WhichAxis = 'Z', SolveInside = True, Transparency=0.7)
