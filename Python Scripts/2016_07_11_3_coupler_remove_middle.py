# -*- coding: utf-8 -*-
"""
Created on Tue Jul 12 16:12:00 2016
...
direction1 = (0,'L_ul+L_u*0.5',0)
direction2 = (0,'-L_ul-L_u*0.5',0)
...
direction1 = (0,'-3*L_ul-L_u*1.5',0)


Move(changed_name1, direction1)
Unite([changed_name1, changed_name2])
