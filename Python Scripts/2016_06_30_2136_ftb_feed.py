# -*- coding: utf-8 -*-
"""
Created on Thu Jun 30 21:33:34 2016
		...
		[
			...
			[
				...
				[
					...
					"UserDef:="		, True,
					"Value:="		, [str(value)+unit if type(value) != type('d') else value][0]  
				]
			]
		]
	]) 
...
add varibles
'''
varible_value = [('wp1',wp1),('ll1',ll1),('p',p),('a',a)]
Add_varible_list(varible_value)

varible_value_without_unit = [('N2', N2), ('N3', N3), ('N4', N4)]
Add_varible_list_without_unit(varible_value_without_unit) 

###=========================================================
list1 = [('-wp1/2', 'll1/N3*'+str(i), '0')  for i in range(N3)]

list2 = [('wp1/2', 'll1/N3*'+str(i), '0')  for i in range(N3)]

list3 = [('-wp1/2+ wp1/N4*'+str(i), '0', '0') for i  in range(1,N4)]
list4 = [('a/2','ll1+w*'+str(i), 0 ) for i in range(N2+1)]
list5 = [('-a/2','ll1+w*'+str(i), 0 ) for i in range(N2+1)]
