...
N_horn= math.ceil(LL/p)

local_var_array = get_design_varibles()
varible_value = [('a', a),('L1',L1),('LL',LL),('rL',rL),('Ra', Ra),('ri',ri)]
Add_varible_list(varible_value)
varible_value_without_unit = [('N_horn', N_horn)]
Add_varible_list_without_unit(varible_value_without_unit) 

pos = [(0, '-ri-(rL-ri)/2/N_horn*'+str(i), 'd/2+LL/N_horn*'+str(i) )   for i in range(N_horn)]
name = ['zhorn'+str(i+1) for i in range(N_horn)]
###===============
