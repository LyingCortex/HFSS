# -*- coding: utf-8 -*-
"""
Created on Mon Aug 15 15:37:34 2016
...
center = (0, 0, 0)
name_bo = 'Circle_Big_o'
name_bi = 'Circle_Big_i'
name_so = 'Circle_Small_o'
name_si = 'Circle_Small_i'

CreateCircle(name_bo, center, 'Rb+w', WhichAxis ='Z')
CreateCircle(name_bi, center, 'Rb', WhichAxis ='Z')
CreateCircle(name_so, center, 'Rs+w', WhichAxis ='Z')
CreateCircle(name_si, center, 'Rs', WhichAxis ='Z')

Substract(name_bo, name_bi )
Rename(name_bo, 'Ring_O')
Substract(name_so, name_si )
Rename(name_so, 'Ring_I')
...
Substract('Ring_O', 'pl1', True )
Substract('Ring_I', 'pl1')