# -*- coding: utf-8 -*-
"""
Created on Tue Sep  6 09:07:54 2016
...
for i  in range(N1):
    ...
    name1.append(namei)
    name.append(namei)
    center = ('-a/2', 'd/2+' + str(i) + '*p', '0')
    CreateCylinder(center, 'd/2', 'b', name1[i], 'pec', unit = 'mm', WhichAxis = 'Z', SolveInside = True, Transparency=0.7)
...
for i in range(N2):
    ...
    name2.append(namej)
    name.append(namej)
    center = ('-a/2-' + dx + '*'+str(i+1), 'd/2+p*'+ str(N1) + '+' + str(i) + '*'+ dy, '0')
    CreateCylinder(center, 'd/2', 'b', name2[i], 'pec', unit = 'mm', WhichAxis = 'Z', SolveInside = True, Transparency=0.7)
