# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 15:55:51 2016
...
varible_value = [('p',p),('L2',L2),('a',a),('b',b)]
...
pos4 = [('-a/2-(D2-a-d/2)/2/N3*'+str(i), 'L1+p*'+str(i), 0) for i in range(1,N3)]
pos5 = [('a/2+(D2-a-d/2)/2/N3*'+str(i), 'L1+p*'+str(i), 0) for i in range(1,N3)]
