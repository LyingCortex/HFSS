# -*- coding: utf-8 -*-
"""
Created on Wed Jun 22 09:39:54 2016
...
################### the design varibles used in the design
local_var_array = get_design_varibles()
varible_value = [('wp1',wp1),('wp2',wp2),('l1',l1),('l2',l2),('p',p),('a',a)]
...
list_siw = [('-a/2', 'l2+w*'+str(i), 0)  for i in range(1, N6+1)]
...
for i in range(len(list_siw)):
    CreateCylinder(list_siw[i], r, h, name_siw[i], material, WhichAxis = 'Z', SolveInside = True, Transparency=0.7)
