# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 16:04:57 2016
Power Divider  
1:3
...
## Z2x
W2x = 0.619
L2x = 1.828   #changed to 2 mm



varible_value = [('W0',W0),('L0',L0),('W0x',W0x),('L0x',L0x),('W1x',W1x),('L1x',L1x),('W1',W1),('L1',L1),('W2',W2),('L2',L2),('W2x',W2x),('L2x',L2x)]
...
Points = [('W0/2', '-L0', 'H'),('W0/2', 0, 'H'),('W0x/2', 0, 'H'),('W0x/2', 'L0x', 'H'),('W1x/2', 'L0x', 'H'),('W1x/2', 'L0x+L1x', 'H'),
('W1/2', 'L0x+L1x', 'H'),('W1/2', 'L0x+L1x+L1', 'H'),('-W1/2', 'L0x+L1x+L1', 'H'),('-W1/2', 'L0x+L1x', 'H'),('-W1x/2', 'L0x+L1x', 'H'),
('-W1x/2', 'L0x+W2x', 'H'),('-L2x', 'L0x+W2x', 'H'),('-L2x', 'L0x+W2x/2+W2/2', 'H'),('-L2x-L2', 'L0x+W2x/2+W2/2', 'H'),('-L2x-L2', 'L0x+W2x/2-W2/2', 'H'),
('-L2x', 'L0x+W2x/2-W2/2', 'H'),('-L2x', 'L0x', 'H'),('-W0x', 'L0x', 'H'),('-W0x', 0, 'H'),('-W0/2', 0, 'H'),('-W0/2', '-L0', 'H'),('W0/2', '-L0', 'H')]

name = 'power_divider_1to3'
material = 'copper'

CreatePolyline(Points, name, material , IsPolylineClosed = False, SolveInside = True, Transparency = 0.7)
sweep_vec=(0,0,'h0')
SweepAlongVector(name, sweep_vec)
