...
varible_value = [('L_u',L_u),('W_u',W_u),('L_l',L_l),('W_l',W_l),('W_ul',W_ul),('L_ul',L_ul),('L_urs',L_urs)]
...
###=============
direction1 = ('-L_l','-L_ul*3-L_u*1.5-L_urs/2',0)
direction2 = ('L_l','-L_ul*3-L_u*1.5-L_urs/2',0)
direction3 = ('-L_l','L_ul*3+L_u*1.5+L_urs/2',0)
direction4 = ('L_l','L_ul*3+L_u*1.5+L_urs/2',0)
direction5 = (0,'L_ul+L_u*0.5+L_urs/2',0)
direction6 = (0,'-L_ul-L_u*0.5-L_urs/2',0)
direction7 = (0,'-L_ul-L_u*0.5-L_urs/2+L_urs+6*L_ul+3*L_u',0)
direction8 = (0,'L_ul+L_u*0.5+L_urs/2+L_urs+6*L_ul+3*L_u',0)
direction = []
N2 = 7
for i  in range(N2):
