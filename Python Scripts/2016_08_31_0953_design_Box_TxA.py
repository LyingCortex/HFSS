# -*- coding: utf-8 -*-
"""
Created on Thu Sep  1 09:49:28 2016
...
for i in range(N):
    for j in range(N):
        ...
        if (xmax ** 2 + ymax ** 2 )**0.5 <= D/2:
            CreateBox(name_bo, (center[0]-L1/2,center[1]-L1/2,T), [L1, L1, H0], 'copper', unit = 'mm', SolveInside = True)
            CreateBox(name_bi, (center[0]-L11/2,center[1]-L11/2,T), [L11, L11, H0], 'copper', unit = 'mm', SolveInside = True)
            CreateBox(name_so, (center[0]-L2/2,center[1]-L2/2,T), [L2, L2, H0], 'copper', unit = 'mm', SolveInside = True)
            CreateBox(name_si, (center[0]-L22/2,center[1]-L22/2,T), [L22, L22, H0], 'copper', unit = 'mm', SolveInside = True)
            ...
            name_list.append('Square_O'+'_'+str(i) +'_'+ str(j))
