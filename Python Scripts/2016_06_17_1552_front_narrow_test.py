# -*- coding: utf-8 -*-
"""
Created on Fri Jun 17 15:52:02 2016
...
relative_via_pos = [(-1,0),(0,1),(1,1),(1,2),(2,2),(0,-1),(1,-1),(1,-2),(2,-2)]
front_via_pos = [(0,-y,z-2) for (z,y) in relative_via_pos]

    
name = ['front_via' + str(i+1)  for i in range(9)]

h= 'b'
material = 'pec'
r= 'd/2'
for i in range(9):
    CreateCylinder(front_via_pos[i], r, h, name[i], material, WhichAxis = 'X', SolveInside = True, Transparency=0.7)
